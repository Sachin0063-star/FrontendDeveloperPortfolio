...
export default function Hero() {
  return (
    <main className='flex flex-col md:flex-row items-center justify-between w-full px-4 md:px-24 pb-4 md:pb-24 pt-24 md:pt-32 gap-8 z-10'>
      <Navbar />
      ...
      >
        ...
        <div className="flex items-center justify-center md:justify-start space-x-4 mb-6">
          <a href="https://github.com/sachin12-say"><img src={github} alt="GitHub" className='w-11 h-11' /></a>
          <a href="https://www.linkedin.com/in/sachin-sharma-6b1529302" target="_blank" rel="noopener noreferrer">
          <img src={linkedin} alt="LinkedIn" className='w-11 h-11' /></a>
          <a href="https://www.facebook.com/share/16c4X1HbBE/"><img src={facebook} alt="Facebook" className='w-11 h-11' /></a>
          <a href="https://www.instagram.com/_rocky_1437/"><img src={instagram} alt="Instagram" className='w-11 h-11' /></a>
        </div>
        ...
        <div className="mt-8 flex justify-center md:justify-start">
          <img
            src={me}
            alt="Profile"
            className="w-22 h-44 rounded-full border-4 border-[#c744c4] shadow-lg hover:scale-110 transition-transform duration-400"
          />
        </div>
      </motion.section>
